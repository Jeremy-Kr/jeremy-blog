---
name: new-post
description: This skill should be used when the user asks to "create a new blog post", "write a new post", "새 포스트 생성", or "새 글 작성". Creates a new MDX blog post with proper frontmatter and structure.
---
