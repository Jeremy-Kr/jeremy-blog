---
name: publish
description: This skill should be used when the user asks to "publish a post", "배포", "퍼블리시", or "/publish". Runs the full publishing pipeline - validate, translate, build, LinkedIn post, and deploy guidance.
---
